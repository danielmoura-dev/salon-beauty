<header class="sticky top-0 z-10 flex items-center gap-4 bg-white border-b border-gray-100 px-4 py-3 lg:hidden">
    ...
    <span class="flex-1 text-center font-bold text-rose-600 tracking-tight flex items-center justify-center gap-1.5">
    ...
    @else
        <div class="h-8 w-8 rounded-full bg-rose-100 flex items-center justify-center text-rose-600 font-semibold text-xs">
